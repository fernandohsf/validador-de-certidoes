...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('C:/Program Files/Python311/Lib/site-packages/fitz', 'fitz/'), ('C:/Program Files/Python311/Lib/site-packages/openpyxl', 'openpyxl/'), ('C:/Program Files/Python311/Lib/site-packages/xlsxwriter', 'xlsxwriter/')],
